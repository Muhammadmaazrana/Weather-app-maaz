...
function App() {
  ...
  const fetchWeatherDataForCity = () => {
    if (city.trim() === '') return;
    fetchWeatherData(null, null); // Reset previous location data
    setCity(city.trim());
  };
  ...
  useEffect(() => {
    if (!city) {
      // Get geolocation and fetch weather data for user's location
      if (navigator.geolocation) {
        navigator.geolocation.getCurrentPosition(
          ...
          (error) => {
            ...
            // Fetch default weather data (e.g., for a city like New York)
            fetchWeatherDataForCity();
          }
        );
      } else {
